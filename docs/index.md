...
hero:
  name: "Demo Centro Estetico"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://centro-estetico.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-centro-estetico
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Centro Estetico.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Centro Estetico** in Italia.
...
Il mercato italiano delle PMI per **Centro Estetico** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:centro-estetico
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-centro-estetico)
