...
URL: `https://centro-estetico.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `centro-estetico.demo.federicocalo.dev`
...
- Output directory: `dist/centro-estetico/browser`
...
URL: `https://fedcal.github.io/federico-demo-centro-estetico/`
...
- `base: /federico-demo-centro-estetico/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `centro-estetico-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   centro-estetico-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `centro-estetico-docs.federicocalo.dev`
